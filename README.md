...
The combined tree contains as its outgroup the taxon “Olindias Sambaquiensis”, and so the four trees were compared by making that as the outgroup for the other three trees. The tree for 16s does not contain this taxon, however, and so to compare this tree with the others I looked for species and the presence of similar clades between the different trees and tried to observe similarities. 
